...
from .views import BrandSearchView, InfluencerSearchView
    ...
    def get_urls(self):
        ...
        urlpatterns = [
            url(r'^$', search_view_factory(
                ...
                name='search'),
            url(r'^search-brands',BrandSearchView.as_view(),name='brand-search'),
            url(r'^search-influencers',InfluencerSearchView.as_view(),name='influencer-search'),
        ]
