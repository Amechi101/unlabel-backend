...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name_plural': 'Influencer Product-Rentals',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height', models.DecimalField(decimal_places=3, default=Decimal('0.000'), help_text='US Measurements', max_digits=10, verbose_name='Height')),
                ('chest_or_bust', models.DecimalField(decimal_places=3, default=Decimal('0.000'), help_text='US Measurements', max_digits=10, verbose_name='Chest or Bust')),
                ('hips', models.DecimalField(decimal_places=3, default=Decimal('0.000'), help_text='US Measurements', max_digits=10, verbose_name='hips')),
                ('waist', models.DecimalField(decimal_places=3, default=Decimal('0.000'), help_text='US Measurements', max_digits=10, verbose_name='waist')),
