...
class CountCondition(Condition):
    ...
    def offer_product_brand_same(self, offer, line):
        if offer.brand:
            if offer.brand == line.product.brand:
                return True
            return False
        return True
    ...
    def is_satisfied(self, offer, basket):
        ...
        for line in basket.all_lines():
            if (self.can_apply_condition(line) and self. offer_product_brand_same(offer, line)
...
class CoverageCondition(Condition):
    ...
    def is_satisfied(self, offer, basket):
        ...
        for line in basket.all_lines():
            ...
            if (self.can_apply_condition(line) and self. offer_product_brand_same(offer, line) and product.id not in
                    covered_ids):
...
class ValueCondition(Condition):
    ...
    def is_satisfied(self, offer, basket):
        ...
        for line in basket.all_lines():
            if (self.can_apply_condition(line)  and self. offer_product_brand_same(offer, line) and
