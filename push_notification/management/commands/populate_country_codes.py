...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        country_codes = { "Abkhazia": "+7 840", "Abkhazia ": "+7 940", "Afghanistan": "+93", "Albania": "+355",
                          "Algeria": "+213", "American Samoa": "+1 684", "Andorra": "+376", "Angola": "+244",
                          "Anguilla": "+1 264", "Antigua and Barbuda": "+1 268", "Argentina": "+54",
        ...
        for key in country_codes:
            tc = TelephoneCode.objects.create(country=key,code=country_codes[key])
            tc.save()
